...
def check_strace_logs(
    ...
    if expected_exec is not None and not traced_runtime_exec:
        raise EvaluationError("network trace does not show the monitor launching the exact runtime executable")
    if attempts:
